...
class AppStrings {
  ...
  static const String loading = 'چاوەڕێ بکە...';
  ...
  static const String pendingApproval = 'چاوەڕێی قبوڵکردن';
  ...
  static const String requestSent =
      'داواکاریت نێردرا؛ تکایە چاوەڕێ بکە تا قبوڵ بکرێت';
  ...
  static const String description = 'وردەکاری';
