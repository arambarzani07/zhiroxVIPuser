...
class PBService {
  ...
  static Future<Map<String, dynamic>> getOwnerHealthOverview() async {
    await ensureInitialized();
    final raw = await client.rpc('get_system_owner_health_overview');
    if (raw is! Map) throw Exception('invalid_owner_health_overview');
    return Map<String, dynamic>.from(raw);
  }

  static Future<Map<String, dynamic>> getOwnerSubscriptionOverview() async {
    await ensureInitialized();
    final raw = await client.rpc('get_system_owner_subscription_overview');
    if (raw is! Map) throw Exception('invalid_owner_subscription_overview');
    return Map<String, dynamic>.from(raw);
  }

  static Future<Map<String, dynamic>> getOwnerSubscriptionsPage({
    int page = 1,
    int perPage = 20,
  }) async {
    await ensureInitialized();
    ...
    if (raw is! Map) throw Exception('invalid_owner_subscriptions_page');
    return Map<String, dynamic>.from(raw);
  }

  static Future<Map<String, dynamic>> setOwnerSubscription({
    required String adminId,
    ...
    if (raw is! Map) throw Exception('invalid_owner_subscription_result');
    return Map<String, dynamic>.from(raw);
  }

  static Future<Map<String, dynamic>> getOwnerSecurityOverview() async {
    await ensureInitialized();
    final raw = await client.rpc('get_system_owner_security_overview');
    if (raw is! Map) throw Exception('invalid_owner_security_overview');
    return Map<String, dynamic>.from(raw);
  }

  static Future<Map<String, dynamic>> getOwnerSecurityPage({
    int page = 1,
    int perPage = 20,
  }) async {
    await ensureInitialized();
    ...
    if (raw is! Map) throw Exception('invalid_owner_security_page');
    return Map<String, dynamic>.from(raw);
  }

  static Future<Map<String, dynamic>> revokeOwnerAdminSessions(
    String adminId,
  ) async {
    await ensureInitialized();
    final raw = await client.rpc(
    ...
    if (raw is! Map) throw Exception('invalid_owner_revoke_sessions_result');
    return Map<String, dynamic>.from(raw);
  }

  static Future<Map<String, dynamic>> setOwnerAdminLock({
    required String adminId,
    ...
    if (raw is! Map) throw Exception('invalid_owner_lock_result');
    return Map<String, dynamic>.from(raw);
  }
  ...
  static Future<Map<String, dynamic>> getOwnerReadinessOverview() async {
    await ensureInitialized();
    final raw = await client.rpc('get_system_owner_readiness_overview');
    if (raw is! Map) throw Exception('invalid_owner_readiness_overview');
    return Map<String, dynamic>.from(raw);
  }

  static Future<Map<String, dynamic>> getOwnerReadinessPage({
    int page = 1,
    int perPage = 50,
  }) async {
    await ensureInitialized();
    ...
    if (raw is! Map) throw Exception('invalid_owner_readiness_page');
    return Map<String, dynamic>.from(raw);
  }
  ...
  static Future<Map<String, dynamic>> getOwnerPlatformAuditPage({
    ...
    if (raw is! Map) throw Exception('invalid_owner_platform_audit_page');
    return Map<String, dynamic>.from(raw);
  }
