...
class _UserProfileScreenState extends State<UserProfileScreen> {
  ...
  bool _isLegacyPlaceholderPhone(String value) =>
      RegExp(r'^legacy_[0-9a-f]{8}_[0-9]+
  @override
  void initState() {
    super.initState();
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      setState(() {
        ...
        _phoneController.text = _visiblePhone(user.getStringValue('phone'));
  ...
  Future<void> _saveProfileChanges() async {
    ...
    final importedWithoutPhone = _isLegacyPlaceholderPhone(existingPhone);
  ...
  Widget build(BuildContext context) {
    ...
    final phone = _visiblePhone(rawPhone);
    final legacySourceId = _legacySourceIdFromPhone(rawPhone);
  ...
  // Profile/password/debt-limit UI lives in user_profile_account_management.dart.
  ...
  String _visiblePhone(String value) {
    final normalized = value.trim();
    return _isLegacyPlaceholderPhone(normalized) ? '' : normalized;
  }

  String? _legacySourceIdFromPhone(String value) {
    final normalized = value.trim();
    if (!_isLegacyPlaceholderPhone(normalized)) return null;
