...
class EmployeeDashboardPhase1Final extends StatefulWidget {
  const EmployeeDashboardPhase1Final({super.key});

  @override
  State<EmployeeDashboardPhase1Final> createState() => _EmployeeDashboardPhase1FinalState();
}

class _EmployeeDashboardPhase1FinalState extends State<EmployeeDashboardPhase1Final> {
  int _currentIndex = 0;
      ...
      child: ListView(
        ...
        children: [
          Container(
            ...
            child: Row(
              children: [
                Container(width: 54, height: 54, decoration: BoxDecoration(color: Colors.white.withOpacity(0.2), borderRadius: BorderRadius.circular(18)), child: const Icon(Icons.badge_rounded, color: Colors.white, size: 30)),
          ...
          GridView.count(
            ...
            mainAxisSpacing: 12,
            children: [
              _ActionCard(title: 'کڕیارەکان', subtitle: 'گەڕان و پڕۆفایل', icon: Icons.people_rounded, cardColor: cardColor, textColor: textColor, subColor: subColor, onTap: () => onOpenTab(1)),
              _ActionCard(title: 'قەرزەکان', subtitle: 'قەرز و پارە وەرگرتنەوە', icon: Icons.receipt_long_rounded, cardColor: cardColor, textColor: textColor, subColor: subColor, onTap: () => onOpenTab(2)),
              _ActionCard(title: 'وەعدی پارەدانەوە', subtitle: 'ڕێککەوتنی کڕیار', icon: Icons.event_available_rounded, cardColor: cardColor, textColor: textColor, subColor: subColor, onTap: () => onOpenTab(1)),
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Container(padding: const EdgeInsets.all(10), decoration: BoxDecoration(color: AppColors.primary.withOpacity(0.1), borderRadius: BorderRadius.circular(14)), child: Icon(icon, color: AppColors.primary)),
          const Spacer(),
